    ...
    <link rel="stylesheet" href="CSS/style.css">
        ...
        <nav>
           <div>
            ...
            <log_in_form class="login-form">
                <h1>Log In</h1>
                    <p>As <a href="manager_login.php" class="active">Manager</a>/<a    href="scholar_login.php">Scholar</a></p>
                        <form action="includes/manager_login.inc.php" method="post">
                            <table>
                                <tr>
                                    <td>
